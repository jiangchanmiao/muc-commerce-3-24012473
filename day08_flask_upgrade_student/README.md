...
- 姓名：曲浩
- 学号：24012473
- 已完成路由或接口：/health、/api/metrics、/api/categories、400 errorhandler
- 测试文件："C:\Users\QH153\PyCharmMiscProject\ecommerce-user-analysis-seed\day08_flask_upgrade_student\test_day08_api.py"
- 尚未解决的问题：问答系统只能回答5类固定问题
qa_service 只识别：总用户数、流失率、品类用户数、生命周期风险、订单数。像"Mobile Phone 和 Fashion 的流失率差多少""订单数超过 3 单的流失率是多少""各品类的平均消费金额排名"这种自然问题，系统全部答不了，直接回一句"请换一种更具体的问法"。
